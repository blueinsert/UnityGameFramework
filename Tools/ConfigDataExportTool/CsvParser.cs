...
namespace bluebean.ConfigDataExportTool
{
    ...
    public class CsvParser
    {
        ...
        public DataGrid ParseFromString(string content)
        {
            Clear();
            RawContent = content;
