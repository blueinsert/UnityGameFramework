        ...
        void LateUpdate()
        {
            ...
            if (solver != null)
            {
                ...
                if (Input.GetMouseButtonDown(0))
                {
                    ...
                    for (int i = 0; i < solver.PositionList.count; ++i)
                    {

                        Vector3 worldPos = solver2World.MultiplyPoint3x4(solver.PositionList[i]);
                    ...
                    if (pickedParticleIndex >= 0)
                    {
                        ...
                        pickedParticleDepth = Camera.main.transform.InverseTransformVector(solver2World.MultiplyPoint3x4(solver.PositionList[pickedParticleIndex]) - Camera.main.transform.position).z;
