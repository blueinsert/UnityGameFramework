...
namespace DataStructures.Trees
{
    ...
    public class BinarySearchTree<T> : IBinarySearchTree<T> where T : IComparable<T>
    {
        ...
        /// <summary>
        /// the internal implement of inserting an element to the tree
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        protected virtual BSTNode<T> _insertImpl(T item)
        {
        ...
        /// <summary>
        /// Inserts an element to the tree, and return the NextSmaller element AND the NextLarger element
        /// </summary>
        /// <param name="item"></param>
        public virtual Tuple<BSTNode<T>, BSTNode<T>> InsertAndReturnNextSmallerLarger(T item)
        {
            var newNode = _insertImpl(item);

            var nextSmallerNode = _findNextSmaller(newNode);
            var nextLargerNode = _findNextLarger(newNode);

            return new Tuple<BSTNode<T>, BSTNode<T>>(nextSmallerNode, nextLargerNode);
        }
        ...
        /// </summary>
        /// <returns>Min</returns>
        public virtual bool FindMin(out T result)
        {
            result = default(T);
            ...
            var findNode = _findMinNode(Root);
            if (findNode == null)
            {
                return false;
            }
        ...
        /// </summary>
        public virtual bool FindNextSmaller(T item, out T result)
        {
            var node = _findNode(Root, item);
        ...
        /// </summary>
        public virtual bool FindNextLarger(T item, out T result)
        {
            var node = _findNode(Root, item);
        ...
        /// </summary>
        /// <returns>Max</returns>
        public virtual bool FindMax(out T result)
        {
            result = default(T);
            ...
            var findNode = _findMaxNode(Root);
            if (findNode == null)
            {
                return false;
            }
        ...
        public virtual BSTNode<T> Find(T item)
        {
            if (IsEmpty)
                return null;
