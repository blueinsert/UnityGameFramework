...
{
    internal partial class FileUtility
    {
        public static string ReadText(string fname)
        {
            ...
            {
                Console.WriteLine("FileUtility.ReadText Error: " + e);
            }
        ...
        public static bool WriteText(string fname, string txt)
        {
            ...
            {
                Console.WriteLine("FileUtility.WriteText Error: " + e);
            }
            return false;
        }
        ...
        public static byte[] ReadBytes(string fname)
        {
            ...
            {
                Console.WriteLine("FileUtility.ReadBytes Error: " + e);
            }
        ...
        public static bool WriteBytes(string fname, byte[] bytes)
        {
            ...
            {
                Console.WriteLine("FileUtility.WriteBytes Error: " + e);
            }
            return false;
        }
        ...
        public static bool DeleteFile(string fname)
        {
            ...
            {
                Console.WriteLine("FileUtility.DeleteFile Error: " + e);
            }
            return false;
        }
        ...
        public static bool IsFileExist(string fname)
        {
            ...
            {
                Console.WriteLine("FileUtility.IsFileExist Error: " + e);
            }
            return false;
        }
    }
