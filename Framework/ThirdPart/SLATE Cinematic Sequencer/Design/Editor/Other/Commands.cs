...
namespace Slate
{
    ...
    public static class Commands
    {
        ...
        [MenuItem("Tools/SLATE/Open SLATE Editor", false, 0)]
        public static void OpenDirectorWindow() {
            CutsceneEditor.ShowWindow(null);
        }

        [MenuItem("Tools/SLATE/Create New Cutscene", false, 0)]
        ...
        [MenuItem("Tools/SLATE/Visit Website", false, 0)]
        public static void VisitWebsite() {
            Help.BrowseURL("http://slate.paradoxnotion.com");
        }

        [MenuItem("Tools/SLATE/Extra/Create Shot Camera")]
        ...
        [MenuItem("Tools/SLATE/Extra/Create Bezier Path")]
        ...
        #endif
        */
        [MenuItem("Tools/SLATE/Extra/Create Cutscene Starter")]
        ...
        [MenuItem("Tools/SLATE/Extra/Create Cutscene Zone Trigger")]
        ...
        [MenuItem("Tools/SLATE/Extra/Create Cutscene Click Trigger")]
        ...
        [MenuItem("Tools/SLATE/Extra/Create Cutscenes Sequence Player")]
