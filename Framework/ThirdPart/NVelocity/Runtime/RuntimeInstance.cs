    ...
    public class RuntimeInstance : IRuntimeServices
    {
        ...
        private void setDefaultProperties()
        {
            try
            {
                ...
                //var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(RuntimeConstants.DEFAULT_RUNTIME_PROPERTIES);
                FileStream fs = new FileStream("Assets/Plugins/BJFramework/NVelocity/Runtime/Defaults/nvelocity.properties", FileMode.Open);
                Stream stream = fs;
                if (stream == null)
                {
                    throw new System.Exception("Assembly.GetExecutingAssembly().GetManifestResourceStream(RuntimeConstants.DEFAULT_RUNTIME_PROPERTIES) == null");
                }
        ...
        private void initializeDirectives()
        {
			...
			*/
            ...
            try
            {
                FileStream fs = new FileStream("Assets/Plugins/BJFramework/NVelocity/Runtime/Defaults/directive.properties", FileMode.Open);
                Stream stream = fs;
                if (stream == null)
                {
                    throw new System.Exception("Assembly.GetExecutingAssembly().GetManifestResourceStream(RuntimeConstants.DEFAULT_RUNTIME_DIRECTIVES) == null");
                }
                ...
                directiveProperties.Load(stream);
            }
            catch (System.Exception ex)
            {
